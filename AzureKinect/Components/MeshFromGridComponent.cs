...
namespace AzureKinect.Components
{
    public class MeshFromGridComponent : GH_Component
    {
        ...
        {
            pManager.AddMeshParameter("Kinect", "M",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // 式式 Vertices: add all grid slots (Unset included).
            ...
            // 式式 Faces: for each grid cell, build a quad if all corners are
        ...
        protected override System.Drawing.Bitmap Icon => IconLoader.Load("Mesh24.png");
